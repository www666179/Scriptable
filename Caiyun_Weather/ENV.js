...
exports.run = async function (scriptName, widget, autoDak = false) {
  ...
  if (
    !exports.configs.changePicBg ||
    exports.configs.colorMode ||
    config.runsInWidget
  ) {
    // 结束并且进行预览
...
function completeWidget(widget) {
  ...
  // 设置边距(上，左，下，右)
  widget.setPadding(
    exports.configs.topPadding,
    exports.configs.leftPadding,
    exports.configs.bottomPadding,
    exports.configs.rightPadding
  );
  // 设置组件
